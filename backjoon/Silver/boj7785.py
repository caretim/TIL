...
# for sqs in range(sq): #On
#     x,y= input().split()
#     inout[x]=y

# # sort_inout=sorted(inout.items(),reverse=True)
# sort_list=[]

# for k,v in inout.items(): #on
#     if v =='enter':
#        sort_list.append(k)

# sort_list.sort(reverse=True)#on

# for reselt in sort_list: #on
#     print(reselt)
